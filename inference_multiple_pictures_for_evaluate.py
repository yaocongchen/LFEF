...
def smoke_segmentation(
    ...
    for filename in pbar:
        ...
        image_overlap(os.path.join(images_dir, filename), i, names)
        image_stitching(os.path.join(images_dir, filename), i, names, os.path.join(masks_dir, filename))
...
if __name__ == "__main__":
    ...
    smoke_segmentation(args["test_directory"], model, device, names, time_train, i)
