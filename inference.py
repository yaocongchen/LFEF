...
if __name__ == "__main__":
	smoke_input_image = read_image('/home/yaocong/Experimental/light_ssd/123.jpg')
	transform = transforms.Resize([256, 256])
	smoke_input_image = transform(smoke_input_image)
	output_f19, output_f34 = smoke_semantic(smoke_input_image,'/home/yaocong/Experimental/light_ssd/checkpoint/bs32e150/final.pth')
