...
import models.CGNet_add_sem_cam_inputout as network_model  # import self-written models 引入自行寫的模型
import utils
...
def train_epoch(model, training_data_loader, device, optimizer, epoch):
    ...
    return RGB_image, mask_image, output, train_desmoke
...
def main():
    ...
    for epoch in range(start_epoch, args["epochs"] + 1):
        train_RGB_image, train_mask_image, train_output, train_desmoke = train_epoch(
